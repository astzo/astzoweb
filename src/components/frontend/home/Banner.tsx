...
const Banner = () => {
  return (
    <div className='w-full min-h-[500px] md:h-[90vh] -mt-[78px] bg-[url(/images/hero.jpg)] bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-white text-center'>
